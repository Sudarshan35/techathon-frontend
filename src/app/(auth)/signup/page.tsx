...
>
  Student
        ...
        <div className="form flex flex-col w-1/2 justify-between m-auto">
          <div className="names flex w-1/2 justify-between">
            <div className="firstname">
              ...
              <input
                ...
                required
                className="rounded-lg text-center h-8 w-60 bg-richblack-800"
              />
            </div>
          ...
          <div
            className="signup h-10 w-60 bg-yellow-500 rounded-full flex items-center justify-center cursor-pointer"
